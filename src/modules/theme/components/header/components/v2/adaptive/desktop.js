...
const DesktopHeader = (props) => {
    ...
    return (
        <div className={cx('desktop-header', 'transition-transform', 'delay-300', 'duration-500', 'ease-in-out', 'shadow-md')}>
            <div
                className={cx(
                    'middle-header', 'tablet:border-b-[1.5px]',
                    'tablet:border-b-neutral-200', 'tablet:py-4',
                    'mobile:py-2',
                )}
            >
                <div
                ...
                >
                    ...
                    <div className={cx('middle-header__statusicon', 'flex items-center justify-end')}>
                        <div
                            className={cx(
                                'middle-header__statusicon__left-section',
                                'flex', 'flex-row', 'gap-x-3', 'justify-end item',
                                'mobile:mt-[4px]',
                            )}
                        >
                            <div className="search-icon">
                                <Button
                                    ...
                                    iconProps={{ className: cx('text-neutral-400', 'w-[19.5px]', 'h-[19.5px]') }}
                                    iconOnly
                                    variant="tertiary"
                                    classNameText={cx('!text-neutral-400')}
                                />
                            </div>
