...
export const frontendConfig = (pwaConfig) => {
    ...
    return `
        :root {
            // general styles
            --color-pwa-primary_color: ${COLORS.primary[300]};
            --color-pwa-secondary_color: ${COLORS.secondary[400]};
            ...
            --color-pwa-button_background_color: ${COLORS.primary[300]};
            ...
            --color-pwa-button_border_color: ${COLORS.primary[300]};
            ...
            --color-pwa-link_hover_color: ${COLORS.neutral[400]};
