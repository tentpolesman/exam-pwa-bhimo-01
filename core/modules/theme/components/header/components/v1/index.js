...
const DesktopHeader = dynamic(() => import('@core_modules/theme/components/header/components/v1/adaptive/desktop'), { ssr: true });
const TabletHeader = dynamic(() => import('@core_modules/theme/components/header/components/v1/adaptive/tablet'), { ssr: true });
const MobileHeader = dynamic(() => import('@core_modules/theme/components/header/components/v1/adaptive/mobile'), { ssr: true });
