...
import MobileHeader from'@core_modules/theme/components/header/components/v1/adaptive/mobile';
import DesktopHeader from'@core_modules/theme/components/header/components/v1/adaptive/desktop';
