...
import Autocomplete from '@core_modules/theme/components/header/components/autocomplete';
import OptionAutocomplete from '@core_modules/theme/components/header/components/autocomplete/view';
import DesktopInstallAppV4 from '@core_modules/theme/components/header/components/v4/custom-install-popup/desktop';
import Menu from '@core_modules/theme/components/header/components/v4/mcategory';
...
const TopMenu = dynamic(() => import('@core_modules/theme/components/header/components/v4/mtop'), { ssr: false });
