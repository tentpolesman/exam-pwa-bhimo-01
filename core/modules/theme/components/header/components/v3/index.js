...
import Menu from '@core_modules/theme/components/header/components/v3/mcategory';
import NotificationBell from '@plugin_notificationbell';
import ShoppingBagIcon from '@plugin_shoppingbag';
import dynamic from 'next/dynamic';
import Link from 'next/link';

const TopMenu = dynamic(() => import('@core_modules/theme/components/header/components/mtop'), { ssr: false });
