...
const MenuChildren = dynamic(() => import('@common_header/components/v3/mcategoryChildren'), { ssr: false });
                        ...
                        return (
                            ...
                            >
                                ...
                                {val.children.length > 0 ? (
                                    <div className={classNames('mega-menu', 'grid')} aria-hidden="true" role="menu" ref={megaMenuRef}>
                                        {val.show_header && (
