...
import DesktopInstallAppV2 from '@core_modules/theme/components/header/components/v2/custom-install-popup/desktop';
import Menu from '@core_modules/theme/components/header/components/v2/mcategory';
                                    ...
                                    <div className="header-middle__icons">
                                        <div className="signin">
                                            <Link href="/customer/account" passHref legacyBehavior>
                                                <Badge color="secondary">{/* <PersonIcon color="secondary" /> */}</Badge>
                                            </Link>
                                        </div>
