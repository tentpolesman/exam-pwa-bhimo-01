    ...
    return (
        <>
            ...
            <div className={classNames(styles.container, 'row')}>
                <div className="lg:basis-full hidden-mobile">
                ...
                && bannerLiteObj.top.map((topBanner) => (
                    <PromoBannersLite
                        ...
                        classes={classNames(styles.bannerLiteTop, 'xs:basis-full')}
                ...
                <div className={classNames(styles.headContainer, 'xs:basis-full lg:basis-1/2')}>
                    ...
                    && bannerLiteObj.top.map((topBanner) => (
                        <PromoBannersLite
                            type="top"
                            key={topBanner.entity_id}
                            classes={classNames(styles.bannerLiteTopMobile, 'xs:basis-full')}
                            src={topBanner.banner_link}
                            imgSrc={topBanner.banner_image}
                            alt={topBanner.banner_alt}
                            storeConfig={storeConfig}
                    ...
                    <div className="flex flex-row">
                        ...
                        && bannerLiteObj.label.map((labelBanner) => (
                            <PromoBannersLite
                                ...
                                classes={classNames(styles.bannerLiteLabel, 'xs:basis-6/12')}
                        ...
                        <div className="flex flex-row">
                            ...
                            && bannerLiteObj.after.map((afterBanner) => (
                                <PromoBannersLite
                                    ...
                                    classes={classNames(styles.bannerLiteAfter, 'xs:basis-6/12')}
